...
namespace FormMahasiswa
{
    public partial class FrmListMahasiswa : Form
    {
        ...
        private void InisialisasiListView()
        {
            ...
            lvwMahasiswa.FullRowSelect = true; lvwMahasiswa.GridLines = true;
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                item.SubItems.Add(mskNpm.Text); item.SubItems.Add(txtNama.Text);
                item.SubItems.Add(jenisKelamin); item.SubItems.Add(txtTempatLahir.Text);
        ...
        {
            mskNpm.Clear(); txtNama.Clear(); rdoLakilaki.Checked = true;
            txtTempatLahir.Clear(); dtpTanggalLahir.Value = DateTime.Today;
            mskNpm.Focus();
        }
        ...
        private void btnHapus_Click(object sender, EventArgs e)
        {
            ...
            {
                var index = lvwMahasiswa.SelectedIndices[0]; var nama = lvwMahasiswa.Items[index].SubItems[2].Text;
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    for(var i=0; i<lvwMahasiswa.Items.Count; i++) //Fungsi Pengurutan
                    {
                        var noUrut = i + 1;
        ...
        private void Double_click(object sender, EventArgs e)//even untuk Double Klik di List View
        {
